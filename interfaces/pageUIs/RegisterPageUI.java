...
public class RegisterPageUI {
	...
	public static final String LASTTNAME_ERROR_MESSAGE = "//span[@id='LastName-error']";
	...
	public static final String WRONG_EMAIL_MESSAGE = "//div[contains(@class,'message-error')]//li";
